...
- **SketchyBar configuration** — the script only starts the service; the Catppuccin theme and module setup are entirely manual. This is a significant chunk of work.
